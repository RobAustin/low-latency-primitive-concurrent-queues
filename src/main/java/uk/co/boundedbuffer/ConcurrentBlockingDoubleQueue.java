...
/**
 * A low latency, lock free, primitive bounded blocking queue backed by an double[].
 ...
 * <td>{@link #offer(double, long, java.util.concurrent.TimeUnit) offer(e, time, unit)}</td>
 * </tr>
 * <tr>
 * <td><b>Remove</b></td>
 ...
 * <p/>
 * <p/>
 * <p>A <tt>uk.co.boundedbuffer.ConcurrentBlockingDoubleQueue</tt> is capacity bounded. At any given
 ...
 * <p/>
 * <p>All of <tt>uk.co.boundedbuffer.ConcurrentBlockingDoubleQueue</tt> methods are thread-safe when used with a single producer and single consumer, internal atomicity
 * is achieved using lock free strategies, such as sping locks.
 * <p/>
 * <p>Like a <tt>BlockingQueue</tt>, the uk.co.boundedbuffer.ConcurrentBlockingDoubleQueue does <em>not</em> intrinsically support
...
public class ConcurrentBlockingDoubleQueue extends AbstractBlockingQueue {
     ...
     * {@link #take()}. {@link #offer(double)}, {@link #put(double)},  {@link #drainTo(double[], int)}}
     *
